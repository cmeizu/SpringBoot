package com.fintechsn.huahuadai.common.bean;
...
public class ResponseResult<T> implements Serializable {
    ...
    public synchronized static <T> ResponseResult<T> succ(T data) {
        ResponseResult<T> res = new ResponseResult<>();
    ...
    public synchronized static <T> ResponseResult<T> fail(String msg) {
        ResponseResult<T> res = new ResponseResult<>();
