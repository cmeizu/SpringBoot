...
public class DateUtils {
    ...
    public static Date parseString2Date(String xDate, String xFormat) {
        ...
        xFormat = StringUtils.isNotEmpty(xFormat) ? xFormat : DEFAULT_FORMAT;
     ...
     * @return
     */
    public static String formatDate(Date date, String xFormat) {
    ...
    public static Date getMouthLastDay(Date date) {
        ...
        StringBuffer str = new StringBuffer().append(dayFirst).append(" 23:23:59");
        df = new SimpleDateFormat(YYYY_MM_DD_HH_MM_SS);
        try {
            return df.parse(str.toString());
        } catch (ParseException e) {
    ...
    public static Date[] getYaerLastTimeLast(Date startDate, Date endDate) {
        Date[] yaerLastTime = getYearLastTime(startDate, endDate);
     ...
     * @return 最后一天
     */
    public static Date[] getYearLastTime(Date startDate, Date endDate) {
        YearMonth[] yearAndMonth = twoDateBetweenYearAndMonth(startDate, endDate);
        if (yearAndMonth.length == 1) {
     ...
     * @return yyyy-mm-dd
     */
    public static Date YYMMDDDate(Date date) {
        Date result = null;
        try {
            SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
