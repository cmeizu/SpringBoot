...
public class ReidsTest {
    ...
    public void testRedis() {
        ...
        //第二种取值方式
        Map map2 = new Gson().fromJson(cacheUtil.get("map"), new TypeToken<Map<String, Object>>() {
        }.getType());
        if (map2 != null) {
        ...
        List<String> newlist1 = new Gson().fromJson(cacheUtil.get("newlist"), new TypeToken<List<String>>() {
        }.getType());
        ...
        List<Map<String, Object>> nowlist1 = new Gson().fromJson(cacheUtil.get("nowlist"), new TypeToken<List<Map<String, Object>>>() {
        }.getType());
        if (nowlist1 != null) {
